...
@section('content')
      ...
      <div class="hero-slide active">
        ...
        <div class="hero-content-wrap">
          <div class="hero-text">
            ...
            <h1 class="hero-title">Level Up Your<br /><span class="gradient-text">Gaming Setup</span></h1>
            <p class="hero-desc">Premium gaming peripherals crafted for champions. Experience the difference with Pouch Gallery®</p>
          ...
          <div class="hero-image-wrap">
            ...
            <img src="{{asset('public/assets/gaming_hero.png')}}" alt="Gaming peripherals collection" class="hero-img" />
          </div>
        </div>
      </div>

      <div class="hero-slide">
        <div class="hero-bg" style="background: #efefef;">
        </div>
        <div class="hero-content-wrap">
          <div class="hero-text">
            <div class="hero-tag">⚡ Flash Sale – 48 Hours Only</div>
            <h1 class="hero-title">Premium Gaming<br /><span class="gradient-text-cyan">Keyboards</span></h1>
            <p class="hero-desc">Mechanical switches, RGB backlight, anti-ghosting. Built for professionals.</p>
            <div class="hero-cta-group">
              <a href="{{url('/gaming-product/1')}}" class="btn btn-primary">Shop Now – ₹3,499 <i class="ri-arrow-right-line"></i></a>
              <a href="#" class="btn btn-ghost">View All</a>
            </div>
          </div>
          <div class="hero-image-wrap">
            <div class="hero-glow cyan"></div>
            <img src="{{asset('public/assets/keyboard.png')}}" alt="Gaming Keyboard" class="hero-img" />
          </div>
        </div>
      </div>
  ...
  <section class="categories-section" id="categories">
    <div class="container">
      ...
      <div class="category-grid">
        <a href="{{url('/gaming-products')}}" class="cat-card cat-gaming reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-gamepad-line"></i></div>
          <div class="cat-info">
            <h3>Gaming</h3>
        ...
        <a href="#" class="cat-card cat-bags reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-briefcase-line"></i></div>
          <div class="cat-info">
            <h3>Bags & Cases</h3>
        ...
        <a href="#" class="cat-card cat-audio reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-headphone-line"></i></div>
          <div class="cat-info">
            <h3>Audio</h3>
        ...
        <a href="#" class="cat-card cat-phone reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-smartphone-line"></i></div>
          <div class="cat-info">
            <h3>Mobile Acc.</h3>
        ...
        <a href="#" class="cat-card cat-storage reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-hard-drive-2-line"></i></div>
          <div class="cat-info">
            <h3>Storage</h3>
        ...
        <a href="#" class="cat-card cat-cables reveal">
          <div class="cat-bg-glow"></div>
          <div class="cat-icon-wrap"><i class="ri-plug-line"></i></div>
          <div class="cat-info">
            <h3>Cables & Hubs</h3>
  ...
  <section class="products-section bg-alt" id="best-sellers">
    <div class="container">
      <div class="section-header">
        <div>
