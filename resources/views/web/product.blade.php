            ...
            <div class="pd-img-panel">
                ...
                <div class="pd-img-btn-row">
                    ...
                    <button type="button" class="pd-bn-btn pd-buynow-btn" data-id="{{ $product->id }}">
                        <span class="pd-bn-text"><i class="fa-solid fa-bolt"></i> BUY NOW</span>
                        <span class="pd-bn-loader d-none"><i class="fa fa-spinner fa-spin"></i> Loading...</span>
                    </button>
                </div>
            </div>
                ...
                <div class="pd-info-main">
                    ...
                    <div class="pd-sel-section">
                        <div class="pd-sel-label">
                            Color <span id="pdColorVal">: Black</span>
                        </div>
                        <div class="pd-colors" id="pdColors">
                            ...
                            $colors = [
                                ...
                                ['name'=>'Red',   'hex'=>'#c62828'],
                                ['name'=>'Olive', 'hex'=>'#5d6e2d'],
                                ['name'=>'Grey',  'hex'=>'#78909c'],
                            ];
                            @endphp
                            @foreach($colors as $i => $c)
                            <div class="pd-color-item {{ $i===0 ? 'selected':'' }}" onclick="pdSelectColor(this,'{{ $c['name'] }}')">
                                <div class="pd-color-circle" style="background:{{ $c['hex'] }};{{ isset($c['border']) ? 'border-color:'.$c['border'].';border-width:1px;' : '' }}"></div>
                    ...
                    <div class="pd-sel-section">
                        <div class="pd-sel-label">
                            Size <span id="pdSizeVal">: M</span>
                            <a href="#" class="pd-size-chart">Size Chart <i class="fa-solid fa-ruler" style="font-size:10px;"></i></a>
                        </div>
                        <div class="pd-sizes" id="pdSizes">
                            @php $sizes = ['XS','S','M','L','XL','XXL']; @endphp
                            @foreach($sizes as $i => $sz)
                            <button class="pd-size-btn {{ $i===2 ? 'selected':'' }}" type="button" onclick="pdSelectSize(this,'{{ $sz }}')">{{ $sz }}</button>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="pd-seller-row">
                        ...
                        <div>
                            <span class="pd-seller-name">BrandsonStore</span>
