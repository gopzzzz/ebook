        ...
        <div class="np-layout">
            <div class="np-sidebar">
                <div class="np-sidebar-user">
                    <div class="np-sidebar-avatar">{{ strtoupper(substr($profile->name, 0, 1)) }}</div>
                    <div>
                        <div class="np-sidebar-name">{{ $profile->name }}</div>
                        <div class="np-sidebar-sub">{{ $orders->count() }} Orders</div>
                    </div>
                </div>
                        ...
                        <div class="np-section-body" style="padding:0;">
                            <div class="np-info-grid">
                                <div class="np-info-cell">
                                    ...
                                    <div class="np-info-cell-val">{{ $profile->name }}</div>
                                </div>
                                <div class="np-info-cell">
                                ...
                                <div class="np-info-cell">
                                    ...
                                    <div class="np-info-cell-val">{{$orders->count()}}</div>
                                </div>
                                <div class="np-info-cell">
                                    <div class="np-info-cell-label">Saved Addresses</div>
                                    <div class="np-info-cell-val">{{$cusAddress->count()}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="np-tab-content" id="np-tab-orders">
                    <div class="np-section-panel">
                        <div class="np-section-head">
                            ...
                            <span style="font-size:13px;color:#878787;">{{$orders->count()}} order(s)</span>
                        </div>
                        <div class="np-section-body">
                            ...
                            <div class="np-order-row">
                                <div class="np-order-top">
                                    <div>
                                        ...
                                        <div class="np-order-meta-val">#{{ $order->order_id }}</div>
                                    </div>
                                    <div>
                                        <div class="np-order-meta-label">Date</div>
                                        <div class="np-order-meta-val">{{ date('d M Y', strtotime($order->created_at)) }}</div>
                                    </div>
                                    <div>
                                ...
                                <div class="np-order-body">
                                    <div class="np-order-amount">₹{{ $order->total_amount }}<small>Total</small></div>
                                    <div class="np-order-btns">
                                        <a href="{{ route('orderview', $order->id) }}" class="np-order-btn-primary" target="_blank">
                            ...
                            <div style="text-align:center;padding:40px 20px;">
                                ...
                                <a href="{{url('product-list')}}" style="display:inline-block;background:#fb641b;color:#fff;padding:11px 28px;border-radius:3px;text-decoration:none;font-weight:700;font-size:14px;">Start Shopping</a>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="np-tab-content" id="np-tab-addresses">
                    <div class="np-section-panel">
                        <div class="np-section-head">
                            ...
                            <span style="font-size:13px;color:#878787;">{{$cusAddress->count()}} saved</span>
                        </div>
                        <div class="np-section-body">
                            @forelse($cusAddress as $address)
                            <div class="np-addr-card">
                                <span class="np-addr-type-badge">HOME</span>
                                <div class="np-addr-street">{{ $address->address }}</div>
                                <div class="np-addr-details">{{ $address->district }}, {{ $address->state }} — {{ $address->pincode }}</div>
                                <div class="np-addr-phone">📞 {{ $address->phone_number }}</div>
                            </div>
                            @empty
                    ...
                    <div class="np-section-panel">
                        ...
                        <div class="np-section-body">
                            <div class="np-settings-row">
                                ...
                                <a href="{{url('logout')}}" class="np-logout-btn">
