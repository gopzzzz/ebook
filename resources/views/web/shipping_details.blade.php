...
<div class="ns-breadcrumb">
    <div class="ns-breadcrumb-inner">
        ...
        <a href="{{url('cart')}}">Cart</a> <span>›</span>
                ...
                <div class="ns-panel">
                    ...
                    <div class="ns-panel-body">
                        ...
                        <label class="ns-addr-option">
                            ...
                            <div>
                                <div class="ns-addr-name">{{ $shipping->address }}</div>
                                <div class="ns-addr-line">{{ $shipping->district }}, {{ $shipping->state }}</div>
                                <div class="ns-addr-pin">{{ $shipping->pincode }}</div>
                                <div class="ns-addr-phone">📞 {{ $shipping->phone_number }}</div>
                                @if($shipping->id == $shipping->ship_id)
...
<input type="hidden" name="razorpay_signature" id="razorpay_signature">
                    ...
                    <div class="ns-item-row">
                        ...
                        <div style="flex:1;min-width:0;">
                            <div class="ns-item-title">{{ $item->name }}</div>
                            <div class="ns-item-qty-price">Qty: {{ $item->qty }}</div>
                        </div>
                        <div class="ns-item-price">₹{{ $item->sr * $item->qty }}</div>
                    </div>
                    @php $sum += ($item->sr * $item->qty); $mrp += ($item->mrp * $item->qty); @endphp
                    @endforeach

                    <div class="ns-price-section">
                        <div class="ns-price-row">
                            <span class="ns-price-label">Price ({{$cartCount}} items)</span>
                            <span class="ns-price-val" id="subtotal">₹{{$mrp}}</span>
                        </div>
                        <div class="ns-price-row">
                            <span class="ns-price-label">Discount</span>
                            <span class="ns-price-val green" id="discount">− ₹{{$mrp - $sum}}</span>
                        </div>
                        <div class="ns-price-row">
