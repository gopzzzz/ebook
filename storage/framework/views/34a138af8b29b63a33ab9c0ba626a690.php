      ...
      <div class="hero-slide <?php echo e($key == 0 ? 'active' : ''); ?>">
        ...
        <div class="hero-content-wrap">
          ...
          <div class="hero-image-wrap">
            ...
            <img src="<?php echo e(asset('public/uploads/banners/'.$b->banner)); ?>" alt="Banner image" class="hero-img" style="border-radius: 10px;" />
          </div>
        </div>
      </div>
  ...
  <section class="products-section" >
    <div class="container">
      <div class="section-header">
        ...
        <!-- <a href="<?php echo e(url('/productlist')); ?>" class="view-all-link">View All <i class="ri-arrow-right-line"></i></a> -->
      </div>
