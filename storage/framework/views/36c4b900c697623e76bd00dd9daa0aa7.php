    ...
    <div class="pl-wrap">
        ...
        <div class="pl-top-bar">
            <div>
                ...
                <span class="pl-top-bar-count">(<?php echo e(count($items)); ?> items)</span>
            </div>
            <div class="pl-cat-tabs">
                <div class="pl-cat-tab pl-active" onclick="plFilter(this,'all')">All</div>
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pl-cat-tab" onclick="plFilter(this,'<?php echo e($cat->id); ?>')"><?php echo e($cat->category_name); ?></div>
        ...
        <div class="pl-grid" id="plGrid">
            ...
            <div class="pl-card" data-cat="<?php echo e($p->cat_id); ?>">
                <div class="pl-card-img-wrap">
                    <a href="<?php echo e(url('product/'.$p->slug)); ?>">
                        <img src="<?php echo e(asset('public/assets/img/items/'.$p->image)); ?>" alt="<?php echo e($p->name); ?>" loading="lazy">
                    </a>
                    <?php if($discPct > 0): ?>
                    <span class="pl-disc-badge"><?php echo e($discPct); ?>% OFF</span>
                    <?php endif; ?>
                ...
                <div class="pl-card-body">
                    <div class="pl-brand"><?php echo e($brand); ?></div>
                    <div class="pl-name"><?php echo e($p->name); ?></div>
                    ...
                    <div class="pl-price-row">
                        <span class="pl-sp">₹<?php echo e(number_format($p->sr, 2)); ?></span>
                        <?php if($p->mrp > $p->sr): ?>
                        <span class="pl-mrp">₹<?php echo e(number_format($p->mrp, 2)); ?></span>
                        <?php if($discPct > 0): ?>
                        <span class="pl-off"><?php echo e($discPct); ?>% off</span>
                        <?php endif; ?>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="pl-card-foot">
                        <?php if($inCart): ?>
                        <a href="<?php echo e(url('cart')); ?>" class="pl-btn-cart go">
                            <i class="fa-solid fa-cart-shopping" style="font-size:13px;"></i> Go to Cart
                        </a>
                        <?php else: ?>
                        <a href="<?php echo e(url('product/'.$p->slug)); ?>" class="pl-btn-cart add " data-id="<?php echo e($p->id); ?>">
...
<?php echo $__env->make('layouts.weblayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ebook\resources\views/web/productlist.blade.php ENDPATH**/ ?>