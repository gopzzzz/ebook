...
>
  <head>
    ...
    <title><?php echo e($app_profile->name); ?> Admin Login</title>
            ...
            <div class="card-body">
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder"><?php echo e($app_profile->name); ?></span>
                </a>
              </div>
              <h4 class="mb-2">Welcome to <?php echo e($app_profile->name); ?> Admin Panel! 👋</h4>
