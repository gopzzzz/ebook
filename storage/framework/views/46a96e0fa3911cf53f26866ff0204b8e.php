...
<div class="nc-page">
    <div class="nc-wrap">
            ...
            <div>
                <div class="nc-items-box">
                    <div class="nc-items-header">
                        <div class="nc-items-title">My Cart <span style="color:#878787;font-size:14px;">(<?php echo e($cartCount); ?> items)</span></div>
                    </div>

                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="nc-item" id="cart-item_<?php echo e($item->product_id); ?>">
                        ...
                        <div class="nc-item-info">
                            <div class="nc-item-name"><?php echo e($item->name); ?></div>
                            <div class="nc-item-seller">Seller: <?php echo e($item->author_name); ?> &nbsp;<span style="color:#388e3c;font-size:12px;">✓ Trusted</span> <br>
                           <?php echo e(!empty($item->size) ? 'Size : '.$item->size : ''); ?>

                        </div>
                            <div class="nc-item-price-row">
                                <span class="nc-item-sp">₹<?php echo e($item->sr); ?></span>
                                <span class="nc-item-mrp">₹<?php echo e($item->mrp); ?></span>
                                <span class="nc-item-disc"><?php echo e(round((($item->mrp - $item->sr) / $item->mrp) * 100)); ?>% off</span>
                            </div>
                            <div class="nc-qty-row">
                                <span class="nc-qty-label">Qty:</span>
                                <div class="nc-qty-ctrl">
                                    <button class="nc-qty-btn quantity-btn btn-increment" data-id="<?php echo e($item->product_id); ?>" data-vid="2">−</button>
                                    <div class="nc-qty-num quantity-value" id="qty_<?php echo e($item->product_id); ?>"><?php echo e($item->qty); ?></div>
                                    <button class="nc-qty-btn quantity-btn btn-increment" data-id="<?php echo e($item->product_id); ?>" data-vid="1">+</button>
                                </div>
                            </div>
                            <div class="nc-item-actions">
                                <a href="#" class="nc-item-act-btn remove-btn btn-increment" data-id="<?php echo e($item->product_id); ?>" data-vid="3">
                ...
                <div class="nc-summary-box">
                    ...
                    <div class="nc-summary-body">
                        <div class="nc-sum-row">
                            <span class="nc-sum-label">Price (<?php echo e($cartCount); ?> items)</span>
                            <span class="nc-sum-val" id="subtotal">₹<?php echo e($mrp); ?></span>
                        </div>
                        <div class="nc-sum-row">
                            <span class="nc-sum-label">Discount</span>
                            <span class="nc-sum-val disc" id="discount">− ₹<?php echo e($mrp - $sum); ?></span>
                        </div>
                        <div class="nc-sum-row">
                        ...
                        <?php if($mrp > $sum): ?>
                        <div class="nc-sum-savings">You will save ₹<?php echo e($mrp - $sum); ?> on this order</div>
                        <?php endif; ?>
                        <a href="<?php echo e(url('shipping_details')); ?>" class="nc-checkout-btn">Place Order</a>
        ...
        <div class="nc-empty-box">
            ...
            <a href="<?php echo e(url('index')); ?>" class="nc-empty-btn">Shop Now</a>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.weblayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ebook\resources\views/web/cart.blade.php ENDPATH**/ ?>