...
<?php endif; ?>
  ...
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <form method="GET" action="<?php echo e(route('banners.store')); ?>" class="d-flex gap-2">
        <input 
          type="text" 
          name="search"
    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="<?php echo e(route('banners.store')); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?> <div class="modal-header">
...
<tr>
  ...
  <td>
    <img src="<?php echo e(asset('public/uploads/banners/'.$banner->banner)); ?>" width="50" height="50" style="object-fit: cover; border-radius: 6px;">
  </td>
   <td> <?php echo e($banner->banner_title); ?>
    ...
    <div class="dropdown position-static">
      ...
      <div class="dropdown-menu">
        <a href="#"
           ...
           data-banner="<?php echo e($banner->banner); ?>"
           data-banner_title="<?php echo e($banner->banner_title); ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="EditBannermodal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form method="POST" id="editBannerForm" enctype="multipart/form-data"> <?php echo csrf_field(); ?> <?php echo method_field('POST'); ?> <div class="modal-header">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  editBannerModal.addEventListener('show.bs.modal', function (event) {
    ...
    // set preview image
    preview.src = banner 
    ? `<?php echo e(asset('uploads/banners')); ?>/${banner}` 
    : '';
    ...
    // update form action
   form.action = "<?php echo e(url('banners/update')); ?>/" + id;
...
<?php echo $__env->make('layouts.mainlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ebook\resources\views/admin/banner.blade.php ENDPATH**/ ?>