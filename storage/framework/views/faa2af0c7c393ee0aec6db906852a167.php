...
<?php endif; ?>
  ...
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <form method="GET" action="<?php echo e(route('categories.index')); ?>" class="d-flex gap-2">
        <input 
          type="text" 
          name="search"
    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form action="<?php echo e(route('categories.store')); ?>" enctype="multipart/form-data" method="POST"> <?php echo csrf_field(); ?> <div class="modal-header">
...
<div class="card-body">
  <div class="table-responsive text-nowrap">
      ...
      <tbody> <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <tr>
         <td><?php echo e($categories->firstItem() + $loop->index); ?></td>
          <td>
           ...
           <td>
    <img src="<?php echo e(asset('public/uploads/banners/'.$category->image)); ?>" width="50" height="50" style="object-fit: cover; border-radius: 6px;">
  </td>
          <td>
    ...
    <div class="modal fade" id="Editmodal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form method="POST" id="editCategoryForm"  enctype="multipart/form-data"> <?php echo csrf_field(); ?> <?php echo method_field('POST'); ?> <div class="modal-header">
...
<?php echo $__env->make('layouts.mainlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ebook\resources\views/admin/category.blade.php ENDPATH**/ ?>